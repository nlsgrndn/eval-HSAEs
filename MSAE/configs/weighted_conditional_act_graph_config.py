...
@dataclass
class WeightedConditionalActivationGraphConfig:
    """Config for creating graphs from weightedconditional activation metrics."""
...
_GRAPH_CONFIGS_LIST = [
    WeightedConditionalActivationGraphConfig(
...
def get_weighted_conditional_act_graph_config(config_name: str = DEFAULT_GRAPH_CONFIG) -> WeightedConditionalActivationGraphConfig:
